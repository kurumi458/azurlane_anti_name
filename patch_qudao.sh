...
download_azurlane () {
    ...
    #url="https://downali.game.uc.cn/s1/2/10/20230213150150_blhx_uc_2022_11_02_18_24_01.apk?x-oss-process=udf/uc-apk,ZBHDhDR0L1piSsK0wpLCng==40eb0a469d705740&did=95d923aa0f36474bab7498e175d0b9c7"
    # 使用curl命令下载apk文件
    #curl -o blhx.apk  $url
